...
> **Worked example:** [Quick start: Indicator — Step 2](/quick_start_indicator.html#step-2-enter-metadata) maps World Bank **SI.POV.DDAY** fields to the template. **This page** defines every metadata element.

Refer to [General instructions](/documenting_general_instructions.html) for features common to all project types.

## Enter the indicator description

The navigation tree in the *Project page* provides access to metadata entry pages defined by the selected template. To create a project and walk through filling fields, see [Quick start: Indicator](/quick_start_indicator.html). 
...
- **`DOI`** (*doi*) A Digital Object Identifier (DOI) for the the indicator. See [General instructions](/documenting_general_instructions.html) for more information on DOIs.
...
See also: [Structural metadata (project)](/documenting_indicator_data_structure.html) · [Observation data](/documenting_indicator_import_data.html)
